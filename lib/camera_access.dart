...
import 'homescreen_page.dart'; // ✅ final destination

class CameraAccess extends StatelessWidget {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'This allows you to take photos and scan documents using your camera',
                        textAlign: TextAlign.center,
                        style: GoogleFonts.poppins(
